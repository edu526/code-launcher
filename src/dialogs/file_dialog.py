...
def show_add_file_dialog(parent, categories, on_add_callback, pre_config=None, default_name=None, default_path=None):
    ...
    Args:
        ...
        default_name: Optional default file name
        default_path: Optional default file path
    """
    pre_category = None
