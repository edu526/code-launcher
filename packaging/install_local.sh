...
echo ""
echo -e "${YELLOW}Optional: Setup keyboard shortcut${NC}"
echo "  1. Open Settings → Keyboard → Keyboard Shortcuts"
echo "  2. Click 'Custom Shortcuts' → '+'"
echo "  3. Name: Code Launcher"
echo "  4. Command: $INSTALL_DIR/code-launcher"
echo "  5. Shortcut: Press Super+Space (or your preference)"
echo ""
